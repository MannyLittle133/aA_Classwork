...
// creat a name variable
//create a score variable
//check to see if the name is in my total scores object 
// if not then init the key value pair where the key is the name and the value is the current score
